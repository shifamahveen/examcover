...
(() => {
  ...
  function Ze(e) {
    for (let t of e)
      'at-root' !== t.kind &&
        ('declaration' === t.kind
          ? (t.important = !0)
          : ('rule' === t.kind || 'at-rule' === t.kind) && Ze(t.nodes));
  }
  function Ge(e) {
    let t = new Set(),
      r = 0,
    ...
    A([n], (e, { parent: n }) => {
      if ('at-rule' === e.kind) {
          ...
          return (
            ...
            void A(e.nodes, (r) => {
              if ('at-rule' === r.kind && '@apply' === r.name) {
                o.add(e);
                for (let n of Je(r, t)) a.get(e).add(n);
              }
            })
          );
        }
        if ('@apply' === e.name) {
          if (null === n) return;
          (r |= 1), o.add(n);
          for (let r of Je(e, t)) a.get(n).add(r);
        }
      }
    });
    let l = new Set(),
  ...
  async function Xt(
    e,
    { base: t = '', loadModule: r = Zt, loadStylesheet: n = Gt } = {}
  ) {
    let i = 0;
  ...
  async function Jt(e, r = {}) {
    let n = t(e),
      o = await (async function (e, t = {}) {
        ...
        n.unshift(
          x('! tailwindcss v4.1.3 | MIT License | https://tailwindcss.com ')
        );
        let u = new Set(),
          d = null,
          f = 0,
